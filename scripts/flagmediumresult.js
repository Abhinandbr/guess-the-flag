...
let performanceHeading = document.getElementById(
  "flagmedium-performance-heading"
);
let resultText = document.getElementById("flagmedium-result-text");
let restartButton = document.getElementById("flagmedium-restart-btn");
let answerContainer = document.querySelector(".flagmedium-result");
...
questions.forEach((question, index) => {
  let isCorrect = question.correctAnswer === userAnswers[index];
...
restartButton.addEventListener("click", () => {
  ...
  window.location.href = "../pages/flagmediumgame.html"; // Redirect to the game page
});
