...
let resultText = document.getElementById("flageasy-result-text");
let restartButton = document.getElementById("flageasy-restart-btn");
let answerContainer = document.querySelector(".flageasy-result");
...
restartButton.addEventListener("click", () => {
  ...
  window.location.href = "../pages/flageasygame.html"; // Redirect to the game page
});
